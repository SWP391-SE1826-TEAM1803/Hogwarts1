        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Insert New Current Date Activity</h5>
                            ...
                            <form action="CurDateActControllerURL" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="CdtID" name="CdtID" required>
                                </div>
